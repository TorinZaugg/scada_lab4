...
client = ModbusClient('192.0.2.130', port=502)
...
#---------------------------------------------------------------------------#
x = 0
rr = client.read_coils(0, 1, unit=0x01)
print rr.getBit(x)
print rr.bits
...
print ""
print "READ 8 Output coils"
print ""
numberOfCoils = 8
rc = client.read_coils(0, numberOfCoils, unit=0x01)
#print boolList2BinString(rc.bits), int(boolList2BinString(rc.bits), 2), rc.bits
print ""
